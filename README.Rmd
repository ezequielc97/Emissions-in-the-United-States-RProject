...
* This project orignially used data  provided by Coursera class "Exploratory Data Analysys" authorized by Johns Hopkins University (https://www.coursera.org/learn/exploratory-data-analysis). This set can be downloaded here:
